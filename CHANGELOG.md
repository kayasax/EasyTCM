...
### Fixed
- `Start-TCMMonitoring`: added `ShouldProcess` call to satisfy PSScriptAnalyzer `PSShouldProcess` rule (CI failure)

## [0.4.2] - 2026-03-24

### Fixed
- Baseline drift test name now includes "TCM" for searchability in Maester report (`TCM Baseline — no new or deleted resources`)
